...
const data =
    fs.readFileSync('C:/Users/jonat/source/repos/aoc2021/day4/input.txt', 'utf8')
        .split("\n\n")
        .slice(0,-1)
...
const solve = (boards: Cell[][][], numbers: number[]) => {
...
let solved = solve(boards,randomNumbers)
// console.log(visualizeBoard (solved.Board))
console.log(calculateScore(solved))